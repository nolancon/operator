...
import (
	...
	apierrors "github.com/storageos/go-api/errors"
)

//go:generate ../../bin/mockgen -build_flags=--mod=mod -destination=mocks/mock_control_plane.go -package=mocks github.com/storageos/operator/internal/storageos ControlPlane
...
func (c *Client) Authenticate(ctx context.Context, username, password string) error {
	...
	if err != nil {
		return apierrors.MapAPIError(err, resp)
	}
